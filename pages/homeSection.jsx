    ...
    <div className="bg-black w-full min-h-screen">
      <section className="page max-w-7xl mx-auto pb-24">
        <div className="mainHead w-2/6 h-20 bg-white mx-auto rounded-none flex mt-0 px-2 items-center justify-between space-x-1">
          ...
          <div className="nameofevent text-black font-bold font-sans text-4xl">
            {" "}
            COSMOPOLITIAN
          </div>
        </div>
        ...
        <div className="tag bg-black mx-auto w-2/6 h-8 ">
          <div className="text-white font-poppins text-3xl flex items-stretch  justify-center">
          ...
          <div className="data col-span-2 mx-12 ">
            ...
            <div className="text-white text-justify">
              <p>
                ...
                tempora, laudantium nemo recusandae quos dolorem aliquam Lorem
                ipsum dolor sit amet consectetur adipisicing elit. Eos
                repellendus iste aspernatur, nulla sit maxime esse est ex
                recusandae quidem. Maiores veniam atque voluptas itaque fugit
                quibusdam quis culpa id. Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Tenetur, tempora? Consequuntur veniam, ex
                natus enim nobis pariatur, illo eum obcaecati aspernatur alias
                inventore quo praesentium velit possimus sequi repellat
                corporis!
              </p>
            </div>
          </div>
          ...
          <div className="data col-span-2 flex-col mx-12">
            ...
            <div className="text-white text-justify pt-2 pb-0 mb-0 ">
              <p>
                ...
                temporibus eum nostrum, harum nesciunt reiciendis debitis
                tempora, laudantium nemo recusandae quos dolorem aliquam Lorem,
                ipsum dolor sit amet consectetur adipisicing elit. Mollitia ab
                magni explicabo, molestiae natus vel delectus perspiciatis! Vero
                corrupti temporibus ea amet quas explicabo, in sed maxime
                similique iste dolorem! Lorem ipsum dolor sit amet consectetur,
                adipisicing elit.lorem istinctio temporibae quos dolorem aliquam
                Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                Mollitia ab magni explicabo
              </p>
            </div>
